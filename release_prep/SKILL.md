...
allowed-tools: Skill(gitea), Bash(./scripts/check_all), Bash(./scripts/fmt), Read(~/.claude/skills/release_prep/**), WebFetch(domain:crates.io), Bash(grep:*), Bash(~/.claude/skills/release_prep/scripts/line_count), Bash(~/.claude/skills/release_prep/scripts/compare_api.sh), Bash(/Users/drew/.claude/skills/release_prep/scripts/compare_api.sh), Bash(~/.claude/skills/release_prep/scripts/compare_docs.sh), Bash(~/.claude/skills/release_prep/scripts/spdx), Bash(~/.claude/skills/release_prep/scripts/check_docs), Bash(ln -s AGENTS.md CLAUDE.md), Bash(cargo:*), Skill(changelog), Skill(github), Bash(git push origin), Bash(git push github), Bash(git remote get-url github), Bash(git remote get-url origin),Bash(git tag:*), Bash(gh repo view:*), Bash(gh repo edit:*), Bash(jq:*), Bash(find:*), Bash(git stash:*), Bash(git checkout:*), Bash(./scripts/check), Bash(./scripts/clippy), Bash(./scripts/tests), Bash(./scripts/docs), Bash(./scripts/native/tests), Bash(./scripts/wasm32/tests),  Read(/tmp/**), Bash(release_prep/scripts/compare_api.sh), Bash(readlink ./CLAUDE.md), Bash(test:*), Bash(git show-ref:*), Bash(echo:*), Bash(git describe:*), Bash(readlink CLAUDE.md), Bash(git rev-parse:*)
---
