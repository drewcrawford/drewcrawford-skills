...
allowed-tools: Skill(gitea), Skill(changelog), Skill(github), Read(~/.claude/skills/release_prep/**), Read(${CLAUDE_PLUGIN_ROOT}/skills/release_prep/**), Read(/tmp/**), WebFetch(domain:crates.io), Bash(~/.claude/skills/release_prep/scripts/line_count), Bash(${CLAUDE_PLUGIN_ROOT}/skills/release_prep/scripts/line_count), Bash(~/.claude/skills/release_prep/scripts/compare_api.sh), Bash(${CLAUDE_PLUGIN_ROOT}/skills/release_prep/scripts/compare_api.sh), Bash(~/.claude/skills/release_prep/scripts/compare_docs.sh), Bash(${CLAUDE_PLUGIN_ROOT}/skills/release_prep/scripts/compare_docs.sh), Bash(~/.claude/skills/release_prep/scripts/spdx), Bash(${CLAUDE_PLUGIN_ROOT}/skills/release_prep/scripts/spdx), Bash(~/.claude/skills/release_prep/scripts/check_docs), Bash(${CLAUDE_PLUGIN_ROOT}/skills/release_prep/scripts/check_docs), Bash(~/.claude/skills/release_prep/scripts/11_ensure_agents_symlink), Bash(${CLAUDE_PLUGIN_ROOT}/skills/release_prep/scripts/11_ensure_agents_symlink), Bash(./scripts/check_all), Bash(./scripts/fmt), Bash(./scripts/check), Bash(./scripts/clippy), Bash(./scripts/tests), Bash(./scripts/docs), Bash(./scripts/native/tests), Bash(./scripts/wasm32/tests), Bash(cargo:*), Bash(grep:*), Bash(jq:*), Bash(find:*), Bash(test:*), Bash(echo:*), Bash(ln -s AGENTS.md CLAUDE.md), Bash(readlink CLAUDE.md), Bash(readlink ./CLAUDE.md), Bash(git status), Bash(git remote:*), Bash(git push origin), Bash(git push github), Bash(git tag:*), Bash(git stash:*), Bash(git checkout:*), Bash(git show-ref:*), Bash(git describe:*), Bash(git rev-parse:*), Bash(gh repo view:*), Bash(gh repo edit:*)
---
